...
public class GatewayServer implements SimpleServer, LoggingServer {
    ...
    public GatewayServer(int HTTPServerPort, int gatewayPeerServerPort, Long gatewayPeerServerID, Map<Long, InetSocketAddress> peerIDtoAddress, int numberOfObservers) throws IOException {
        ...
        this.peerServerId = gatewayPeerServerID;
        this.peerServer = new GatewayPeerServerImpl(gatewayPeerServerPort, 0, gatewayPeerServerID, peerIDtoAddress, numberOfObservers);
